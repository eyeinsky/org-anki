...
(defvar-local org-anki-sync-request nil
  "Buffer local variable for synchronous org-mode editing.")
...
(defun org-anki--sync-notes (notes &optional buffer)
  ;; :: [Note] -> IO ()
  "Syncronize NOTES."

  (if notes
      (let ((curbuf (or buffer (current-buffer))))
        (promise-chain
